...
def get_players_ratings_list(write_file=True, file_name="sofascore_players_ratings"):
    players_average_ratings_dict = get_players_average_ratings(write_file, file_name)
...
# get_players_ratings_list(file_name="sofascore_semi_players_ratings")
